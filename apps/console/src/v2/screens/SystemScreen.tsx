...
export function SystemScreen({ ctx }: { ctx: ScreenCtx }) {
  ...
  if (status === "error" || !data) {
    return <><EmptyState icon="server" title="Could not load system health" sub="Check your connection or try again." /><button className="sh-btn" type="button" onClick={reload}>Retry health</button></>;
  }
