...
| `BROWSER_CORS_ORIGINS` | No | `https://app.example.com` | Non-secret comma-separated browser app origins allowed to post SDK telemetry directly to public ingestion endpoints. |
