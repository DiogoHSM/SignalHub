...
| `DATABASE_URL` | Yes | `postgres://signalhub:example-local-password-change-me@localhost:5432/signalhub` | Postgres URL for local Node commands. Use the same password as `POSTGRES_PASSWORD`; URL-encode reserved characters. |
